/*
 * @(#)QuaquaManager.java 4.0  2007-11-24
 *
 ...
 * @version 4.0 2007-11-24 Support for Darwin 9.1 added. 
...
public class QuaquaManager {
    ...
    private static void updateAvailableLAFs() {
        ...
        try {
            ...
            lafs.put("CrossPlatform.15","ch.randelshofer.quaqua.leopard.Quaqua15LeopardCrossPlatformLookAndFeel");
        }
    }
