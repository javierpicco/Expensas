/*
 * @(#)QuaquaButtonBorder.java  1.4  2006-12-24
 *
 ...
 * @version 1.4 2006-12-24 by Karl von Randow: Use Images class to create artwork.
...
public class QuaquaButtonBorder implements Border, UIResource {
    ...
    public boolean isFixedHeight(JComponent c) {
        ...
        return style.equals("text")
        || style.equals("push")
        || style.startsWith("toggle");
    }
