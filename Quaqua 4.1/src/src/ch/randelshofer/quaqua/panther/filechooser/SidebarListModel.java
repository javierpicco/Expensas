/*
 * @(#)SidebarListModel.java  3.0.1  2007-11-02
 *
 ...
 * @version 3.0.1 2007-11-02 Remove leaf nodes from system items. 
    ...
    private void validate() {
        ...
        dispatcher.dispatch(
            ...
            public void finished(Object value) {
                ...
                if (userItems.size() > 0) {
                    if (DEBUG) System.out.println("SidebarListModel.fireIntervalAdded "+systemItemsSize+".."+(systemItemsSize + oldUserItemsSize - 1));
                    fireIntervalAdded(
                            SidebarListModel.this,
                            systemItemsSize,
                            systemItemsSize + oldUserItemsSize - 1
