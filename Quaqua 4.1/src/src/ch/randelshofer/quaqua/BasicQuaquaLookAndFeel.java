/*
 * @(#)BasicQuaquaLookAndFeel.java  1.22  2007-11-25
 *
 ...
 * @version 1.22 2007-11-25 Support for Darwin added.
...
public class BasicQuaquaLookAndFeel extends LookAndFeelProxy {
    ...
    protected void initColorDefaults(UIDefaults table) {
        ...
        Object[] objects = {
            ...
            "Table.gridColor", listBackground,
    ...
    protected void initGeneralDefaults(UIDefaults table) {
        ...
        Object[] objects = {
            ...
            "Slicer.requestFocusEnabled", isRequestFocusEnabled,
