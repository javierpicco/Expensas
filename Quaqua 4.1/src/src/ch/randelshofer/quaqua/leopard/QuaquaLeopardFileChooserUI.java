/*
 * @(#)QuaquaLeopardFileChooserUI.java  1.0  2007-11-10
 *
 ...
 * @version 1.0 2007-11-10  Created.
 */
public class QuaquaLeopardFileChooserUI extends BasicFileChooserUI {
    ...
    public void installComponents(JFileChooser fc) {
        ...
        browser.setCellRenderer(fileRenderer);
    ...
    private void updateSelection() {
        ...
        /*
            ...
            //System.out.println("QuaquaLeopardFileChooserUI.setSelectionPaths to "+list);
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (chosenNode != null) {
                ...
                if (subtreeModel.getPathToRoot().isDescendant(new TreePath(chosenNode.getPath()))) {
                    ...
                    /*
                    if (sidebarTree != null) {
                        TreeModel sidebarModel = sidebarTree.getModel();
                        for (int i=0, n = sidebarModel.getSize(); i < n; i++) {
                            ...
                            if (info != null &&
                                    ...
                                    sidebarTree.getSelectedIndex() != i) {
                                sidebarTree.setSelectedIndex(i);
                                return;
                            }
                        }
