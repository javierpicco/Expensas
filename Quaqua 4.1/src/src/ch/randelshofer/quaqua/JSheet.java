 ...
 * @version 2.1.1 2007-11-24 Don't call toFront() on parent window when running
 * on Darwin.
...
public class JSheet extends JDialog {
    ...
    static {
        isNativeSheet = QuaquaManager.isOSX() &&
            ...
            timer.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent evt) {
                    ...
                    if (now > endTime) {
                        ...
                        if (QuaquaManager.getOS() == QuaquaManager.DARWIN) {
                            toFront();
                        } else {
