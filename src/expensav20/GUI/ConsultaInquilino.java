...
import informes.InformeListadoInquilinos;
 ...
 * @author  Javier
 */
public class ConsultaInquilino extends javax.swing.JFrame implements Security{
    private ConsultaCuentaCorriente ccc;
    private ConsultaPagos cp;
    /** Creates new form ConsultaPropietario */
    public ConsultaInquilino() {
        initComponents();
    ...
    public ConsultaInquilino(ConsultaCuentaCorriente ccc) {
        initComponents();
        this.jCmb_Consorcio.setModel(new ComboConsorciosModel());
        this.jCmb_Unidad.setModel(new ComboUnidadesModel());
        this.jCmb_Consorcio.updateUI();
        ...
        this.jBtn_Modificarf.setEnabled(false);
        this.setCcc(ccc);
        
    }
    public ConsultaInquilino(ConsultaPagos cp) {
        initComponents();
        this.jCmb_Consorcio.setModel(new ComboConsorciosModel());
        this.jCmb_Unidad.setModel(new ComboUnidadesModel());
        this.jCmb_Consorcio.updateUI();
    ...
    private void initComponents() {
        ...
        jBtn_Modificarf = new javax.swing.JButton();
        ...
        setTitle("Consulta de Inquilinos");
        ...
        jBtn_Modificarf.setIcon(new javax.swing.ImageIcon(getClass().getResource("/expensav20/GUI/Icons/page_white_edit.png")));
        jBtn_Modificarf.setText("Modificar");
        jBtn_Modificarf.setName("jBtn_Modificar");
        jBtn_Modificarf.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jBtn_ModificarfActionPerformed(evt);
            }
        });
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Inquilinos"));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jTxt_Nombre, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 271, Short.MAX_VALUE)
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jCmb_Consorcio, 0, 271, Short.MAX_VALUE)))
                    .addComponent(jCmb_Unidad, 0, 271, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void jBtn_ListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtn_ListarActionPerformed
        InformeListadoInquilinos ili=new InformeListadoInquilinos();
    ...
    private void jBtn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtn_EliminarActionPerformed
         if (this.jTlb_Resultados.getSelectedRow()==-1){
           JOptionPane.showMessageDialog(this.getContentPane(),"Debe seleccionar un inquilino previamente");
           return;
        }
        if(JOptionPane.showConfirmDialog(this.getContentPane(),"Está seguro que desea eliminar el inquilino?")==JOptionPane.YES_OPTION){
            Inquilino inq=(Inquilino)((TableResultadosModel)this.jTlb_Resultados.getModel()).getLst().get(this.jTlb_Resultados.getSelectedRow());
            if (inq.eliminar()!=0){
                JOptionPane.showMessageDialog(this.getContentPane(),"El inquilino fue eliminado correctamente");
                this.actualizar();
            }
            else{
    ...
    private void jBtn_ModificarfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtn_ModificarfActionPerformed
        if (this.jTlb_Resultados.getSelectedRow()==-1){
           JOptionPane.showMessageDialog(this.getContentPane(),"Debe seleccionar un inquilino previamente");
           return;
        }
        Inquilino inq=(Inquilino)((TableResultadosModel)this.jTlb_Resultados.getModel()).getLst().get(this.jTlb_Resultados.getSelectedRow());
        AltaInquilinos ai=new AltaInquilinos(inq,this);
        ai.setVisible(true);

    }//GEN-LAST:event_jBtn_ModificarfActionPerformed
    ...
    private void jBtn_ConsultarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtn_ConsultarActionPerformed
        ...
        List lst=inq.buscarxCriteria(nombre,cuit,con_codigo,uni_codigo);
    ...
    private void jBtn_SalirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtn_SalirActionPerformed
        ...
        if (this.getCcc()!=null){
            if (this.jTlb_Resultados.getSelectedRow()!=-1){
                Inquilino inq=(Inquilino)((TableResultadosModel)this.jTlb_Resultados.getModel()).getLst().get(this.jTlb_Resultados.getSelectedRow());
                this.getCcc().setInquilino(inq);
                this.getCcc().setearInquilino(inq.getNombre());
            }
        }
        if (this.getCp()!=null){
            if (this.jTlb_Resultados.getSelectedRow()!=-1){
                Inquilino inq=(Inquilino)((TableResultadosModel)this.jTlb_Resultados.getModel()).getLst().get(this.jTlb_Resultados.getSelectedRow());
                this.getCp().setInquilino(inq);
                this.getCp().setearInquilino(inq.getNombre());
            }
        }
        this.dispose();
    ...
    private javax.swing.JButton jBtn_Modificarf;
    ...
    class TableResultadosModel implements TableModel{
        ...
        public Object getValueAt(int rowIndex, int columnIndex) {
            switch(columnIndex){
                case 0:
                    return ((Inquilino)this.getLst().get(rowIndex)).getNombre();
                case 1:
                    return ((Inquilino)this.getLst().get(rowIndex)).getDomicilio();
                case 2:
                    return ((Inquilino)this.getLst().get(rowIndex)).getLocalidad();
                case 3:
                    return ((Inquilino)this.getLst().get(rowIndex)).getCuit();
            }
    ...
    public ConsultaCuentaCorriente getCcc() {
        return ccc;
    }

    public void setCcc(ConsultaCuentaCorriente ccc) {
        this.ccc = ccc;
    }
    ...
    public Map getObjectsAffected() {
        ...
        a.put(this.jBtn_Modificarf.getName(),this.jBtn_Modificarf);
        return a;
    }

    public String getUIName() {
        return "ConsultaInquilino";
    }
    public void sizeTable()
   {
        this.jTlb_Resultados.getColumnModel().getColumn(0).setPreferredWidth(161);
        this.jTlb_Resultados.getColumnModel().getColumn(1).setPreferredWidth(209);
        this.jTlb_Resultados.getColumnModel().getColumn(2).setPreferredWidth(92);
        this.jTlb_Resultados.getColumnModel().getColumn(3).setPreferredWidth(82);
   }
}
